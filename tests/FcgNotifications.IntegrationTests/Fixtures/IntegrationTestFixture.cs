...
public class IntegrationTestFixture : IAsyncLifetime
{
    ...
    /// <summary>
    /// Executa uma ação com um <see cref="FcgNotificationsDbContext"/> apontando para o banco de testes
    /// </summary>
    public async Task ExecuteDbContextAsync(Func<FcgNotificationsDbContext, Task> action)
    {
